  ...
  return (
    <div
      className={`p-5 rounded-2xl border transition flex flex-col gap-4 ${
        isUnread
          ? "bg-[#05568D] border-white/25 shadow-md shadow-[#05568D]/10"
          : "bg-[#05568D]/60 border-slate-800"
      }`}
    >
      ...
      <div>
        ...
        <p className="text-slate-300 text-sm leading-relaxed bg-[#033e66]/40 p-4 rounded-xl border border-slate-800/80 whitespace-pre-line">
          {feedback.message}
        </p>
      </div>
